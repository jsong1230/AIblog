...
### 프로젝트 문서 구조 정리
- **Issue**: 프로젝트 관리 문서(TODO, README, HISTORY)의 위치가 일관되지 않음
- **Solution**: 
  - `HISTORY.md`를 `docs/` 폴더에서 루트 디렉토리로 이동
  - `docs/README.md`의 링크 업데이트
  - 루트 `README.md`의 프로젝트 구조 섹션 업데이트
- **Files Modified**:
  - `HISTORY.md` (이동)
  - `docs/README.md`
  - `README.md`
...
- **Commits**:
  - `8b7e7a4` - "Refactor: 프로젝트 폴더 구조 정리"
...
- **Files Modified**:
  ...
  - `env.example`
- **Commits**:
  - `8b4d6a4` - "Chore: 하루 포스트 생성 개수 3개로 조정"
...
- **Files Modified**:
  ...
  - `auto_publish.py`
- **Commits**:
  - `23ea5d7` - "Fix: 포스트 생성 시 날짜를 한국시간(KST) 기준으로 수정"
